...
namespace Lumina
{
    void FReflectedStructProperty::AppendDefinition(Reflection::FCodeWriter& Writer) const
    {
        ...
        AppendPropertyDef(Writer, PropertyFlagStr.c_str(), "Lumina::EPropertyTypeFlags::Struct", CustomData);
    }
