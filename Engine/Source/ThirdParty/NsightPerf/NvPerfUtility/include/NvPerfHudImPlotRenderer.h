...
#error ImGui versions 1.79 or below do not support tables
    ...
    {
        // Lumina patch: ImGui 1.92 removed ImFont::FontSize (dynamic font sizing). Use the bound
        // font size accessor instead. Re-apply this if the Nsight Perf SDK is updated.
